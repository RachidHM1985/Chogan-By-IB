               ...
               <>
                <Row className="d-flex justify-content-center align-items-center">
                  <Col xs={12} md={6} className="text-left d-flex flex-column align-items-center">
                    ...
                    <Typography variant="h6" sx={{ fontWeight: '600', textAlign: 'center' }}>{produit.description}</Typography>
                ...
                <ReviewsSection tableName='aurodhea' productId={produit.code_produit} isInsertComment={true} />
              </>
            )
          )}
        </Box>
